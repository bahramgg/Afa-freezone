...
export default function ForeignWalletsPage() {
  ...
  const absorbWallet = useForeignStore((s) => s.absorbWallet);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="مدیریت والت"
        description="افزودن و اثبات مالکیت والت‌های شخصی برای دریافت کریپتو"
        actions={<WalletOwnershipDialog lang="en" onVerified={absorbWallet} />}
      />
      ...
      <p className="text-xs text-muted-foreground">
        اثبات مالکیت با امضای یک متن توسط خودِ والت انجام می‌شود؛ کلید خصوصی شما هرگز وارد سامانه
        نمی‌شود.
      </p>
    </div>
  );
