...
export function serializeInvoice(
  ...
  return {
    ...
    dbId: i.id,
    trxId: i.trxRef,
    /** EXPORT or IMPORT — which way the goods, and the money, are going. */
    tradeDirection: i.direction,
    direction: (i.direction === "IMPORT" ? "SEND" : "RECEIVE") as "SEND" | "RECEIVE",
    ...
    beneficiaryWallet: i.beneficiaryWallet ?? undefined,
    depositAccount: i.depositAccount ?? undefined,
    exchangeRate: num(i.exchangeRate),
    rialAmount: num(i.rialAmount),
    rialReceiptNo: i.rialReceiptNo ?? undefined,
